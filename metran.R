...
###First make sure cell counts are entered at the bottom of the file (first column: cell_counts)###

#script directory
script.dir <- "/home/niek/Documents/scripts/ms_tools"

#set data directory
setwd("/run/user/1000/gvfs/smb-share:server=jcbc-store01.jcbc.private.cam.ac.uk,share=citiid_home/nw416/My Documents/Data/HDAC3 project/Results/GC-MS/2022_09_26 Niek minusHT2/AIAEXPRT.AIA")

#prepare data for read into R
system(paste("bash",file.path(script.dir,"prepare4metran.sh")))
